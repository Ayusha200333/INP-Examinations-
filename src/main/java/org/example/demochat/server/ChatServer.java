package org.example.demochat.server;
...
import org.example.demochat.client.ChatClient;
...
public class ChatServer {
    ...
    private void openClientWindow() {
        Platform.runLater(() -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/demochat/chat_client.fxml"));
